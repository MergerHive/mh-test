...
import { useGetBusinessProfileByProfileIDandUserIDQuery } from '../CreateProfilePage/ProfileSlice';
...
const PreviewBusinessProfile = () => {
    ...
    const { data, isLoading } = useGetBusinessProfileByProfileIDandUserIDQuery(profileID, {
    ...
    const BusinessDetails = () => {
        const divsArray = [
            ...
            { label: 'Website', value: data?.businessDetails?.companyWebsite || 'Not Available' },
