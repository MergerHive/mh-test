...
import { useGetInvestorProfileByUserIDQuery } from './InvestorSlice';
import Avatar from 'react-avatar';

const PreviewInvestorProfile = () => {
    ...
    const Overview = () => {
        const divsArray = [
            ...
            { label: 'Company Name', value: data?.investorProfile?.company || 'Not Available' },
            { label: 'Company Website', value: data?.investorProfile?.companyWebsite || 'Not Available' },
                        ...
                        <div className='max-w-5xl m-auto w-full'>
                            <div className='flex gap-4'>
                                <div className='w-1/2 py-5'>
                                    <div className='flex gap-4'>
                                        {data?.investorProfile?.investorImage[0]?.image ? <Avatar className='rounded-md' src={data?.investorProfile?.investorImage[0]?.image} size="200" /> : <Avatar className='rounded-md' facebookId="100008343750912" size="200" />}
...
export default PreviewInvestorProfile